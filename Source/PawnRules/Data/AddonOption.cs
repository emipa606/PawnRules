...
{
    private AddonOption(PawnRulesLink link, string key, OptionTarget target, OptionWidget widget, string label,
        string tooltip, Type type, object defaultValue, bool allowedInPreset)
    {
        Link = link;
        Key = key;
        Target = target;
