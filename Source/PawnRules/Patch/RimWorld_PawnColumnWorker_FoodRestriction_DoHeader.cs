...
{
    private static readonly PawnColumnDef RulesColumnDef = new()
    {
    ...
    private static readonly DummyColumnWorker ColumnWorker = new() { def = RulesColumnDef };
    ...
    {
        public void DoHeaderDummy(Rect rect, PawnTable table)
        {
